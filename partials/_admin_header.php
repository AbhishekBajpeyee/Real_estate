...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="_post.php">iDiscuss</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="_post.php">Home</a>
                </li>
                <li class="nav-item">
...
echo '</div>
               <a href="./profile.php?userid='.$_SESSION['sno'].'"  <p  class="text-light my-0 mx-2"><img  src="'.$img.'" width="40" height="40" "></p></a>
    ...
    echo  '<form class="d-flex mr-2" role="search">
