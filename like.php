            ...
            <article class="col-xs-12 col-sm-6 col-md-3" id="post<?php echo $row['id']?>">
               <div class="panel panel-default">
                  <div class="panel-body">
                     <img src="home.jpg"height="200" width="200"<?php echo $row['image']?> alt="<?php echo $row['title']?>" />
                     </a>
                  </div>
                  <div class="panel-footer">
                     <h4><?php echo $row['title']?></h4>
                     <span class="pull-right">
                        <i class="far fa-thumbs-up<?php echo $likeClass?> fa-thumbs-up" onclick="setLikeDislike('like','<?php echo $row['id']?>')" id="like_<?php echo $row['id']?>"></i>
